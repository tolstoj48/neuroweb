  ...
  try {
    ...
    */
    if (filename && event == 'rename') {
      ...
      let shortenedFilenameForDbSearch = filename.slice(0, filename.search(annotationFlag));
      ...
      await File.updateMany({ local_disk_name: {$regex: shortenedFilenameForDbSearch, $options: 'I' }}, { status: 'done' });
    }
  } catch (error) {
    console.log(error)
  }
