...
function searchTable() {
  ...
  // Write the number in the document
  document.getElementById("number-of-fulltext-results").textContent = numberOfFulltextResults;
}